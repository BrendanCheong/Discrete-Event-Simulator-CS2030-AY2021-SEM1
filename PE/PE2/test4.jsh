Rand.of(2030).map(x -> x / 2).get()
Rand.of(2030).map(x -> x / 2).next().get()
Rand.of(2030).flatMap(x -> Rand.of(x).map(y -> y / 2)).get()
Rand.of(2030).flatMap(x -> Rand.of(x).map(y -> y / 2)).next().get()
