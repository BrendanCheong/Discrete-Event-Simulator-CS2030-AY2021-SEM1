...
public class Simulator {
    ...
    private final LinkedList<Double> selfCheckOutRestArray;
    ...
    public Simulator(int numberOfServers, List<Double> timeArray, int numberOfCustomers, 
        ...
        int numberOfSelfCheckout, LinkedList<Double> selfCheckOutRestArray) {
    ...
    public Simulator(int numberOfServers, List<Double> timeArray, int numberOfCustomers, 
        ...
        LinkedList<Double> selfCheckOutRestArray) {
        ...
        this.selfCheckOutRestArray = selfCheckOutRestArray;
        createServers(numberOfServers, queueAmount, numberOfSelfCheckout);
        ...
        IntStream
            ...
            .forEachOrdered((index) -> {
                SelfCheckoutServer server = new SelfCheckoutServer(index + numberOfServers,
                    queueAmount, this.restTimeArray);
                this.serverList.add(server);
            });
    }
