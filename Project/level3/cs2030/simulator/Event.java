...
public class Event {
    ...
    public Event wait(Server server) {
        return new Event(this.getCustomerNotNull().setWait(), server,
            "WAIT", this.getTime());
    }

    public Event leave() {
        return new Event(Optional.<Customer>of(this.getCustomerNotNull().setLeave()), 
    ...
    public Optional<Event> processArriveEvent(List<Server> serverList) {
        ...
        outputEvent = serverList
            ...
            .map((server) -> {
                Event servedEvent = new Event(this.getCustomerNotNull().setServed(),
        ...
        if (serveCondition == false) {
            outputEvent = serverList
                ...
                .map((server) -> {
                    Event waitEvent = new Event(this.getCustomerNotNull().setWait(),
        ...
        if (!serveCondition) {
            Optional<Customer> customer = 
                Optional.<Customer>of(this.getCustomerNotNull().setLeave());
